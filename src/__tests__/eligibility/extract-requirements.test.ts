...
const requisitos: RequisitosHabilitantes = {
  experiencia_especifica:
    "Experiencia específica mínima de 3.000 SMMLV en construcción de redes de acueducto (UNSPSC 83101500), máximo 3 contratos.",
...
describe("extractStructuredRequirements", () => {
  it("lanza si no hay GEMINI_API_KEY", async () => {
    await expect(extractStructuredRequirements(requisitos, { apiKey: undefined })).rejects.toThrow(
      /GEMINI_API_KEY/
    );
  });
