...
const C = {
  // ── Layout ──
  root:      {display:"flex",flexDirection:"column",height:"calc(100vh - 52px)",overflow:"hidden",fontFamily:"var(--font-ibm-plex-mono),monospace",background:"#020C10",color:"#E8F8FF"},
  ...
  // ── Header typography ──
  logo:      {fontSize:"18px",fontWeight:"900",color:"#00F5FF",fontFamily:"var(--font-orbitron),sans-serif",textShadow:"0 0 16px rgba(0,245,255,0.4)"},
  ...
  inp:       {background:"rgba(4,24,32,0.9)",border:"1px solid rgba(0,245,255,0.12)",borderRadius:"4px",padding:"5px 8px",color:"#E8F8FF",fontSize:"12px",fontFamily:"var(--font-ibm-plex-mono),monospace",width:"100%",boxSizing:"border-box",outline:"none",transition:"border-color 0.2s"},
  ...
  rv:        (hi)=>({fontSize:"26px",fontWeight:"700",color:hi?"#00F5FF":"#6ac8e8",lineHeight:1.1,fontFamily:"var(--font-orbitron),sans-serif"}),
  ...
  dv:        {fontSize:"17px",fontWeight:"700",color:"#00F5FF",fontFamily:"var(--font-orbitron),sans-serif"},
  ...
  cv:        (ok)=>({background:ok?"rgba(0,255,136,0.12)":"rgba(255,176,32,0.12)",color:ok?"#00FF88":"#FFB020",fontWeight:"600",fontSize:"10px",fontFamily:"var(--font-ibm-plex-mono),monospace",padding:"2px 8px",borderRadius:"20px",whiteSpace:"nowrap",flexShrink:0}),

  // ── KPI cards ──
  kpi:       {background:"#041820",border:"1px solid rgba(0,245,255,0.12)",borderRadius:"8px",padding:"12px",textAlign:"center"},
  kv:        (c)=>({fontSize:"22px",fontWeight:"700",color:c||"#00F5FF",fontFamily:"var(--font-orbitron),sans-serif",lineHeight:1.1}),
  ...
  pv:        {fontSize:"18px",fontWeight:"700",color:"#00F5FF",fontFamily:"var(--font-orbitron),sans-serif"},
  ...
  ev:        {fontSize:"22px",fontWeight:"700",fontFamily:"var(--font-orbitron),sans-serif"},
  ...
  fml:       {padding:"14px 16px",background:"rgba(4,24,32,0.9)",border:"1px solid rgba(0,245,255,0.10)",borderRadius:"8px",fontSize:"10px",color:"#4A7A8A",lineHeight:"2.0",fontFamily:"var(--font-ibm-plex-mono),monospace"},
