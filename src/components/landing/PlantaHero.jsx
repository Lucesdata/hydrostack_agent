...
const BUBBLES = [[345,300],[366,316],[320,346],[301,361],[341,376],[371,391],[401,401],[431,386],[456,361],[471,341],[481,316],[506,301],[441,286],[411,271],[391,286],[361,336],[416,346],[299,321]];
  ...
  return (
    <div className="pt-wrap">
      ...
      <div className="pt-float">
        ...
        <ellipse rx="78" ry="78" fill="none" stroke="#000" strokeOpacity=".1" strokeWidth="9"></ellipse>
        ...
        <ellipse rx="79" ry="79" fill="none" stroke="#000" strokeOpacity=".1" strokeWidth="9"></ellipse>
        <g style={{ transformOrigin: "0 0", animation: "pt-spin 24s linear infinite", animationDelay: "-9s" }}>
        ...
        <defs>
        <clipPath id="pt-water"><path d={WATER_CLIP}></path></clipPath>
        </defs>
        <g clipPath="url(#pt-water)">
        <g style={{ animation: "pt-drift 7s linear infinite" }}>
        <g transform="translate(-48,-24)">
          {STREAKS.map(([x, y], i) => (
            <path key={i} d={`M${x} ${y}l26 13`} stroke="#EAF7FF" strokeOpacity=".22" strokeWidth="2.6" strokeLinecap="round"></path>
          ))}
        </g>
        </g>
        <g>
        {BUBBLES.map(([x, y], i) => (
          <circle
            ...
            r={3.4 + (i % 3) * 0.9}
            fill="#EAF7FF"
            style={{ transformBox: "fill-box", transformOrigin: "center", animation: `pt-bub ${4.2 + (i % 5) * 0.7}s ease-out ${(i * 0.42).toFixed(2)}s infinite` }}
          ></circle>
        ))}
        </g>
        </g>
        ...
        <ellipse cx="811" cy="246" rx="68.5" ry="33" fill="none" stroke="#000" strokeOpacity=".18" strokeWidth="6"></ellipse>
        <g style={{ animation: "pt-level 11s ease-in-out infinite" }}>
        <ellipse cx="811" cy="247" rx="64" ry="26.5" fill="#6ECDDB"></ellipse>
        <ellipse cx="811" cy="247" rx="64" ry="26.5" fill="none" stroke="#8FDCE7" strokeWidth="2.5"></ellipse>
        ...
        <path d="M238 470 C 300 424, 345 388, 400 344" strokeDasharray="9 11" style={{ animation: "pt-flow 9s linear infinite" }}></path>
        <path d="M425 322 C 490 285, 540 250, 590 228" strokeDasharray="9 11" style={{ animation: "pt-flow 9s linear infinite", animationDelay: "-1.2s" }}></path>
        <path d="M622 230 C 690 240, 745 250, 795 260" strokeDasharray="9 11" style={{ animation: "pt-flow 9s linear infinite", animationDelay: "-2.4s" }}></path>
        </g>

        <g fontFamily="'JetBrains Mono',monospace" fontWeight="600">
        <g style={{ opacity: "0", animation: "pt-in .6s ease 1.4s forwards" }}>
        <path d="M225 470 L225 120 L152 74" stroke="#0369A1" strokeWidth="1.6" strokeDasharray="420" strokeDashoffset="420" style={{ animation: "pt-draw .9s ease 1.5s forwards" }}></path>
        <rect x="20" y="24" width="130" height="48" fill="#FCFCF9" opacity=".93"></rect>
        <text x="142" y="44" textAnchor="end" fill="#6B746F" fontSize="13" fontWeight="400" letterSpacing="1.4">01 · ENTRADA</text>
        <text x="142" y="66" textAnchor="end" fill="#0369A1" fontSize="18">Q = 48 L/s</text>
        <circle cx="225" cy="470" r="10" fill="#0369A1" opacity=".3" style={{ animation: "pt-ping 3s ease-out infinite" }}></circle>
        <circle cx="225" cy="470" r="5.5" fill="#0369A1"></circle>
        </g>

        <g style={{ opacity: "0", animation: "pt-in .6s ease 1.85s forwards" }}>
        <path d="M412 332 L330 590 L196 716" stroke="#0369A1" strokeWidth="1.6" strokeDasharray="470" strokeDashoffset="470" style={{ animation: "pt-draw 1s ease 1.95s forwards" }}></path>
        <rect x="188" y="696" width="226" height="48" fill="#FCFCF9" opacity=".93"></rect>
        <text x="200" y="716" fill="#6B746F" fontSize="13" fontWeight="400" letterSpacing="1.4">02 · REACTOR BIOLÓGICO</text>
        <text x="200" y="738" fill="#0369A1" fontSize="18">DBO 18 mg/L</text>
        <circle cx="412" cy="332" r="10" fill="#0369A1" opacity=".3" style={{ animation: "pt-ping 3s ease-out .7s infinite" }}></circle>
        <circle cx="412" cy="332" r="5.5" fill="#0369A1"></circle>
        </g>

        <g style={{ opacity: "0", animation: "pt-in .6s ease 2.3s forwards" }}>
        <path d="M604 228 L676 116 L744 116" stroke="#0369A1" strokeWidth="1.6" strokeDasharray="220" strokeDashoffset="220" style={{ animation: "pt-draw .9s ease 2.4s forwards" }}></path>
        <rect x="750" y="68" width="176" height="48" fill="#FCFCF9" opacity=".93"></rect>
        <text x="758" y="88" fill="#6B746F" fontSize="13" fontWeight="400" letterSpacing="1.4">03 · CLARIFICADOR</text>
        <text x="758" y="110" fill="#0369A1" fontSize="18">SST 12 mg/L</text>
        <circle cx="604" cy="228" r="10" fill="#0369A1" opacity=".3" style={{ animation: "pt-ping 3s ease-out 1.4s infinite" }}></circle>
        <circle cx="604" cy="228" r="5.5" fill="#0369A1"></circle>
        </g>

        <g style={{ opacity: "0", animation: "pt-in .6s ease 2.75s forwards" }}>
        <path d="M812 268 L964 470 L964 674" stroke="#16A34A" strokeWidth="1.6" strokeDasharray="470" strokeDashoffset="470" style={{ animation: "pt-draw 1s ease 2.85s forwards" }}></path>
        <rect x="688" y="676" width="278" height="48" fill="#FCFCF9" opacity=".93"></rect>
        <text x="956" y="696" textAnchor="end" fill="#6B746F" fontSize="13" fontWeight="400" letterSpacing="1.4">04 · VERTIMIENTO · RES. 0631</text>
        <text x="956" y="718" textAnchor="end" fill="#16A34A" fontSize="18">pH 7.2 · CUMPLE</text>
        <circle cx="812" cy="268" r="10" fill="#16A34A" opacity=".3" style={{ animation: "pt-ping 3s ease-out 2.1s infinite" }}></circle>
