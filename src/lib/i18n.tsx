...
const translations = {
  ...
  en: {
    ...
    calculators: {
      ...
      septicDesc: "Complete sizing: volumes, chambers, pipes, verifications and infiltration field.",
      ...
      uasbDesc: "Upflow anaerobic sludge blanket. Flow velocities, retention time and organic load.",
      ...
      potDesc: "Coagulation, flocculation, sedimentation, filtration and disinfection. Potable water plants.",
    },
    badge: {
      free: "Free access",
