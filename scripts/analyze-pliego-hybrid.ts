...
async function main(): Promise<void> {
  ...
  if (!documentoBase) {
    process.stderr.write('Uso: npm run analyze-pliego-hybrid <documento-base.pdf> [--formulario1 <xls>]\n');
    process.exit(1);
  }
  ...
  process.stdout.write(JSON.stringify({ ...extraction, _validation: validation, _origen: origen }, null, 2) + '\n');
