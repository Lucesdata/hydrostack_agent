...
const translations = {
  es: {
    ...
    agent: {
      title: "Hydro_Agent",
      subtitle: "SITARD · CTE DB-HS 5 · EN 12566 · RAS",
      welcome: "Soy Hydro_Agent. Pregúntame cómo dimensionar tu fosa séptica o explícame el CTE DB-HS 5.",
  ...
  en: {
    ...
    agent: {
      title: "Hydro_Agent",
      subtitle: "SITARD · CTE DB-HS 5 · EN 12566 · RAS",
      welcome: "I'm Hydro_Agent. Ask me to size your septic system or explain CTE DB-HS 5.",
      ...
      suggestions: [
        "Size a septic tank for 6 equivalent inhabitants",
        "What does CTE DB-HS 5 require for distances to wells?",
        "Differences between a septic tank and a SITARD",
        "Generate a basic schematic for a single-family home",
      ],
